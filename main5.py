...
class ChatBot(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            if "browser" in user_input.lower():

                
                browser_task = f"""Go to https://brainlox.com/courses/category/technical and use extract_content to extract all the course names and description, then return it to me as a CourseList"""
                ...
                if browser_result:
                    bot_response = f"Course Information:\n{browser_result}"
                     ...
                     bot_response = "Could not get the course information."
